...
public class FaqActivity extends AppCompatActivity {
    ...
    private TextView answer1, answer2, answer3, answer4; // Vastauksen tekstikentät
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Etsi vastauksen tekstikentät layout-tiedostosta
        answer1 = findViewById(R.id.answer1);
        answer2 = findViewById(R.id.answer2);
        answer3 = findViewById(R.id.answer3);
        answer4 = findViewById(R.id.answer4);

        // Piilota vastauksen tekstikentät aluksi
        ...
        // Aseta kysymyslaatikoiden klikkaustapahtumat
